...
abstract final class AppTypography {
  ...
  static TextStyle get displaySmall =>
      GoogleFonts.ibmPlexSans(fontSize: 36, fontWeight: FontWeight.w400);

  static TextStyle get headlineLarge =>
      GoogleFonts.ibmPlexSans(fontSize: 32, fontWeight: FontWeight.w400);

  static TextStyle get headlineMedium =>
      GoogleFonts.ibmPlexSans(fontSize: 28, fontWeight: FontWeight.w400);

  static TextStyle get headlineSmall =>
      GoogleFonts.ibmPlexSans(fontSize: 24, fontWeight: FontWeight.w400);

  static TextStyle get titleLarge =>
      GoogleFonts.ibmPlexSans(fontSize: 22, fontWeight: FontWeight.w400);

  static TextStyle get titleMedium =>
      GoogleFonts.ibmPlexSans(fontSize: 16, fontWeight: FontWeight.w500);

  static TextStyle get titleSmall =>
      GoogleFonts.ibmPlexSans(fontSize: 14, fontWeight: FontWeight.w500);

  static TextStyle get bodyLarge =>
      GoogleFonts.ibmPlexSans(fontSize: 16, fontWeight: FontWeight.w400);

  static TextStyle get bodyMedium =>
      GoogleFonts.ibmPlexSans(fontSize: 14, fontWeight: FontWeight.w400);

  static TextStyle get bodySmall =>
      GoogleFonts.ibmPlexSans(fontSize: 12, fontWeight: FontWeight.w400);
